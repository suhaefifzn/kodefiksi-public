<footer class="mt-5" itemscope itemtype="https://schema.org/WPFooter">
    <div class="bg-custom-2 px-0">
        ...
        <nav class="navbar justify-content-start navbar-expand-lg justify-content-lg-center px-3 px-md-0" itemscope itemtype="https://schema.org/SiteNavigationElement" aria-label="Footer navigation">
            <ul class="navbar-nav">
